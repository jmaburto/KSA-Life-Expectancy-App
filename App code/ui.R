          ...
          tabPanel("Overview",
                     mainPanel(
                       ...
                       div(h4(a("Vladimir Canudas-Romo", href="https://researchers.anu.edu.au/researchers/canudas-romo-v"), 
                           ...
                           style = "text-align:justify;"),
                       br(),
                       div(h3('World Bank correspondents'),
                           style = "text-align:justify;"),
                       div(h4('Montserrat Meiro-Lorenzo, Tamer Samah Rabie and Christopher H. Herbst'),
                           style = "text-align:justify;"),
                       br(),
                       ...
                       div(h4('Canudas-Romo, V and Aburto, JM. 2019. Saudi Arabia Health Profile Interactive Application. Available at:
                                https://population-health.shinyapps.io/saudi-arabia-health-profile/'),
                           style = "text-align:justify;"),
                       br(),
                       br()
                       ))
